interface BookShelfSeparatorProps {
    width?: string;
}

interface BookShelfLegProps {
    flip: boolean;
}

const BookShelfLeg: React.FC<BookShelfLegProps> = ({ flip }) => (
...
export function BookShelfSeparator({ width = "80" }: BookShelfSeparatorProps) {
    return (
