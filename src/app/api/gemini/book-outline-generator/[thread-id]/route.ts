...
const INSTRUCTION_PROMPT_A = 'あなたは小説家です.物語の続きを執筆するために,作品を読み,物語の方向性や展開の可能性を示すあらすじを300文字以内で作成してください.このあらすじは,作者自身が物語の構造やテーマを把握し.続きを書く際の指針となるようにしてください.以下の点を意識してまとめてください：\n主人公の目的や葛藤を明示する.\n物語の舞台や雰囲気を簡潔に描写する.\n今後の展開の可能性や伏線を示唆する.\n読者向けではなく、作者自身の創作支援を目的とする.\n\n出力形式は以下の通りです：\n{"summary": "ここに300文字以内の創作支援用あらすじを記述"}';
