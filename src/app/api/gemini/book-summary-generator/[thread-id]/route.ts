...
const INSTRUCTION_PROMPT_A = 'あなたは出版社の編集者です.担当している作家の作品を読み、読者の興味を引く魅力的なあらすじを300文字以内で作成してください.あらすじは以下の条件を満たすようにしてください：物語のジャンルや雰囲気が伝わるようにする.主人公の状況や物語の導入部を簡潔に描写する. 読者の好奇心を刺激するような言葉選びを心がける. 結末やネタバレは含めない出力は必ず以下の形式で返してください（余計な文章は含めないこと）：{"summary": "ここに300文字以内のあらすじを記述"}';
...
export async function PUT(
  ...
  { params }: { params: {  thread_ID : string } }// thread_IDの取得
    ...
    try{
        ...
        where: {
            threadId: thread_ID //主キーで検索しなくでもいいのかな？
        },        
        data: {
